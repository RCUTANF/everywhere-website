...
对于其它事实上主流的模型提供商（例如 通义千问 Qwen、智谱清言 GLM、豆包 Doubao 等），在兼容现有 API 协议的前提下，可以查阅<DynamicLink href="/[lang]/docs/model-provider/other">其他提供商</DynamicLink>在进阶模式进行手动配置和使用。

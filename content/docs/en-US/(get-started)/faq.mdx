...
For other mainstream model providers (such as Qwen, GLM, and Doubao) that are compatible with existing API protocols, you can refer to the <DynamicLink href="/[lang]/docs/model-provider/other">Other Providers</DynamicLink> guide to manually configure and use them via Advanced Mode.
